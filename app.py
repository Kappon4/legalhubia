...
st.set_page_config(
    page_title="LegalHub Elite v9.1", 
    page_icon="⚖️", 
    layout="wide",
...
# ==========================================================
# 2. CONEXÃO COM BANCO (FORCE IPv4 - SOLUÇÃO DEFINITIVA)
# ==========================================================
def get_connection_string_ipv4(uri):
    """
    Desmonta o link do banco, força o DNS a encontrar apenas o IP numérico (IPv4)
    e remonta o link. Isso impede que o Streamlit tente usar IPv6.
    """
    try:
        parsed = urlparse(uri)
...
def get_db_connection():
    ...
    # TENTATIVA BLINDADA: Usa o IP numérico direto
    try:
...
if CONEXAO_NUVEM:
    try:
        # Tenta criar tabelas silenciosamente
        ...
        with st.container(border=True):
            ...
            with tab1:
                ...
                if st.button("🆘 Resetar Admin"):
                    ...
                    if res: st.success("Resetado! Use: admin / admin")
                    else: st.error("Falha na conexão. Tente a aba SUPORTE.")
